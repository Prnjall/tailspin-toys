...
- Comment why a fixture, assertion, or setup step is non-obvious; do not comment code that already clearly expresses the test behavior.
- Keep test comments current with the behavior they justify.
