...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic, non-obvious interactions, or the reason for a test constraint; do not narrate the test steps.
